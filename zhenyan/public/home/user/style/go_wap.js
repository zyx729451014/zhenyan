...
switch (location.host) {
    ...
    case "bbs.fengniao.com":
        ...
        if (location.pathname == '/forum/') {
            go_url = 'https://m.fengniao.com/forum_list.php';
        }
        //精华
        if (/\/jinghua-(\d+)\.html/.test(location.pathname)) {
            ...
            go_url = 'https://m.fengniao.com/forum_' + go_id + '_3.html';
        }
        //帖子看图页
    ...
    case "www.fengniao.com":
        ...
        if (/^\/pe\/camera\.html$/.test(location.pathname)) {
            go_url = 'https://m.fengniao.com/pe/list15.html';
        }

        //镜头新品 /pe/lens.html
        if (/^\/pe\/lens\.html$/.test(location.pathname)) {
            go_url = 'https://m.fengniao.com/pe/list268.html';
        }
        ...
        if (/^\/pe\/(\d+)\/$/.test(location.pathname)) {
            ...
            go_url = 'https://m.fengniao.com/pe/' + go_id + '.html';
        }
    ...
    case "diving.fengniao.com":
        go_url = 'https://m.fengniao.com/forum_515/';
        break;
    case "news.fengniao.com":
        go_url = 'https://m.fengniao.com/news/';
        break;
    ...
    case "sgq.fengniao.com":
        //四光圈首页
        if (location.pathname == '/') {
            go_url = 'https://m.fengniao.com/sgq/';
        }
        if (/\/article\/list/.test(location.pathname)) {
            go_url = 'https://m.fengniao.com/sgq/list.html';
        }
        if (/\/author/.test(location.pathname)) {
            go_id = location.pathname.match(/\d+/g);
            go_id = go_id.toString();
            go_arr = go_id.split(",");
            go_url = 'https://m.fengniao.com/sgq/author-' + go_arr[0] + '.html';
        }
        if (!go_url) {
            go_url = 'https://m.fengniao.com/sgq/';
        }
    ...
    case "wkt.fengniao.com":
        if (location.pathname == '/') {
            go_url = 'https://wkt.fengniao.com/h5/';
        }
        if (/\/detail_\d+\.html/.test(location.pathname)) {
            go_id = location.pathname.match(/\d+/g);
            go_url = 'https://wkt.fengniao.com/h5/goodsDetail/' + go_id + '/1';
        }
        break;
    default:
        //go_url = 'https://m.fengniao.com/';
