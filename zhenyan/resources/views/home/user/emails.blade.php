		...
		<div class="content clearfix">
			...
			<div class="form-wrapper">
					...
					<div class="form-item">
						...
						<div class="form-field">
							<div class="mobile-vcode-text" style="width:278px;">
								<input type="text" class="form-text" name="emailcode" id="mobilecode">
								<button  type="button" id="get_mobile_vcode"  class="get-mobile-vcode code" onclick="sendemailcode()" style="border:none;">获取邮箱校验码<!-- 重新发送(60) --></button>
							</div>
