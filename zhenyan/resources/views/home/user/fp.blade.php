...
<body>
	<div id="container">
		...
		<div class="content clearfix">
			...
			<div class="find-way cf">
				
				<div class="way-item fl">
					<a href="/home/user/mobile" class="way-icon mobile" title="手机取回"></a>
					<h4>手机取回</h4>
					<p>如果您的账号已绑定手机，强烈建议您选用手机找回，方便快捷</p>
				</div>
				<div class="way-item fl">
					<a href="/home/user/emails" class="way-icon email" title="邮箱取回"></a>
					<h4>邮箱取回</h4>
					<p>如果您的账号未绑定手机或者已更换手机，那么可以选用邮箱找回，同样方便</p>
				</div>
			</div>
		</div>
