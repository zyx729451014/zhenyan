...
<body>
	<div id="container">
		...
		<div class="content clearfix">
			...
			<form action="/home/user/updateemail2" method='post'>
				{{ csrf_field() }}
				<div class="form-wrapper">
	                    <div class="form-item">
							<label class="form-label" for="mobile">邮箱</label>
							<div class="form-field">
								<div class="mobile-text" id="password2_tips">
									<input type="text" name="email"   style='width:275px;height:35px;border:1px solid #ddd;font-size:16px;' placeholder="请输入邮箱" id="email" value="{{ $email }}" readonly>
								</div>
			 				</div>
						</div>
						<div class="form-item">
