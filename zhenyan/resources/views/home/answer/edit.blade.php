...
<body>
	<div class="content" style="margin-top:90px;">
		<form method="post" action="/home/answer/{{ $answer->id }}">
			{{ csrf_field() }}
			{{ method_field('PUT') }}
			<span style="font-size:15px;line-height:40px;">问题:</span>	<input type="text" value="{{ $answer->title }}" name="title" class="title" style="width:900px;">
