...
@section('content-wrapper')
  <div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">推荐位广告添加</h4>
        <form class="form-sample" method="post" action="/admin/adver" enctype="multipart/form-data">
        {{ csrf_field() }}
          <div class="row">
            <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="atitle" value="{{ old('atitle') }}"/>
                </div>
              </div>
            </div>                     
          </div>
          <div class="row">
            <div class="col-md-7">
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="url" class="form-control" name="aurl" value="{{ old('aurl') }}"/>
                </div>
              </div>
            </div>                     
          </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                      <div class="input-group col-xs-12">
                        <input type="file" class="form-control file-upload-info" placeholder="图片" style="background-color:#fff;" name="apic">
                        <img src="">
                      </div>
